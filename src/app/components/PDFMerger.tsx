...
const FileItem = ({ 
  ...
  return (
    <div 
      ref={ref}
      className={`p-3 mb-2 bg-white rounded-md shadow-sm border border-gray-200 flex items-start gap-3 ${
        isDragging ? "opacity-50" : "opacity-100"
      }`}
    >
      <div className="flex-shrink-0 w-10 h-12 bg-gray-100 rounded flex items-center justify-center mt-1">
        {file.thumbnail ? (
      ...
      <div className="flex-grow">
        <div className="flex items-start justify-between">
          <p className="text-sm font-medium text-black break-words pr-2 w-full" title={file.name}>
            {file.name}
          </p>
